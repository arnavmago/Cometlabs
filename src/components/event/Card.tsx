      ...
      {props.details && (
        <Stack sx={{ mb: "20px" }}>
          <Box sx={{ display: "flex", justifyContent: "space-between" }} alignItems="center">
            ...
            {props.details.websiteUrl && (<IconButton href={props.details.websiteUrl || "#"} target="_blank" color="primary" size="small" aria-label={props.details.title}><FaLocationArrow style={{ fontSize: "1.3rem" }} /></IconButton>)}
          </Box>
          <Box sx={{ height: "60px" }}>
            {props.details.desc ? (
